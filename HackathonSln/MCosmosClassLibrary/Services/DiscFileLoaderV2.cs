...
namespace MCosmosClassLibrary.Services
{
    public class DiscFileLoaderV2
    {
        ...
        {
            return new DiscFileLoaderV2(sourceFilePath, fileHeadings).results;
        }

        private DiscFileLoaderV2(string sourceFilePath, FileHeadings fileHeadings)
        {
